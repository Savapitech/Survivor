...
export function docInteractionsPost() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        'Creates a new interaction between a recruiter and a seeker.',
    }),
    ApiBody({
...
export function docInteractionsGetRecuiter() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        'Returns the list of interactions sent by a recruiter matching the specified filters.',
    }),
    ApiQuery({
      name: 'recruiterId',
      required: true,
...
export function docInteractionsGetSeeker() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        'Returns the list of interactions received by a seeker matching the specified filters.',
    }),
    ApiQuery({
      name: 'seekerId',
      required: true,
...
export function docInteractionsGetUnread() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        'Returns the number of unread interactions received by a seeker.',
    }),
    ApiQuery({
      name: 'seekerId',
      required: true,
...
export function docInteractionsDeleteFavorite() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        'Removes the favorite interaction between a recruiter and a seeker.',
    }),
    ApiQuery({
      name: 'recruiterId',
      required: true,
