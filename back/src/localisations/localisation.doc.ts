...
export function docLocalisationsGetById() {
    return applyDecorators(
        ApiOperation({
            ...
            description:
                'Returns a single localisation using its numeric id.',
        }),
        ApiParam({
            name: 'id',
            type: Number,
...
export function docLocalisationsPatch() {
    return applyDecorators(
        ...
        ApiOperation({
            ...
            description:
                'Updates an existing localisation. Admin access required.',
        }),
        ApiParam({
            name: 'id',
            type: Number,
...
export function docLocalisationsDelete() {
    return applyDecorators(
        ...
        ApiOperation({
            ...
            description:
                'Deletes an existing localisation. Admin access required.',
        }),
        ApiParam({
            name: 'id',
            type: Number,
