...
export function docMessagesPost() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description: 'Creates a new message between a recruiter and a seeker.',
    }),
    ApiBody({
...
export function docMessagesGetConversationsForRecruiter() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description: 'Returns the conversations associated with a recruiter.',
    }),
    ApiQuery({
      name: 'recruiterId',
      type: Number,
...
export function docMessagesGetConversationsForSeeker() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description: 'Returns the conversations associated with a seeker.',
    }),
    ApiQuery({
      name: 'seekerId',
      type: Number,
