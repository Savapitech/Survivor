...
export function docQuestionnairePost() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        'Creates a new questionnaire question. Admin access required.',
    }),
    ApiBody({
...
export function docQuestionnaireGet() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        'Returns the list of questionnaire questions matching the specified filters.',
    }),
    ApiResponse({
      status: 200,
...
export function docQuestionnaireGetById() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        'Returns a single questionnaire question using its numeric id.',
    }),
    ApiParam({
      name: 'id',
      type: Number,
...
export function docQuestionnairePatch() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        'Updates an existing questionnaire question. Admin access required.',
    }),
    ApiParam({
      name: 'id',
      type: Number,
...
export function docQuestionnaireDelete() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        'Deactivates a questionnaire question. The question is not permanently deleted. Admin access required.',
    }),
    ApiParam({
      name: 'id',
      type: Number,
...
export function docQuestionnaireGetCurrentAttempt() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        'Returns the current questionnaire attempt for a seeker, or creates one if no current attempt exists.',
    }),
    ApiQuery({
      name: 'seekerId',
      required: true,
    ...
    ApiResponse({
      status: 200,
      description:
        'Current questionnaire attempt successfully retrieved or created.',
      schema: {
        type: 'object',
        properties: {
          id: {
...
export function docQuestionnaireSaveAnswers() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        'Saves or updates the answers associated with a questionnaire attempt.',
    }),
    ApiParam({
      name: 'id',
      type: Number,
