...
export function docSeekersGetByUserId() {
  return applyDecorators(
    ApiOperation({
      ...
      description:
        'Returns the seeker profile linked to the specified user ID.',
    }),
    ApiParam({
      name: 'userId',
      required: true,
...
export function docSeekersGetAdmin() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        'Returns every seeker profile without filtering by certification, age, or video status.',
    }),
    ApiQuery({
      name: 'page',
      required: false,
...
export function docSeekersGetById() {
  return applyDecorators(
    ...
    ApiQuery({
      ...
      type: Number,
      description:
        'Optional recruiter ID used to customize the returned seeker data.',
      example: 12,
    }),
    ApiQuery({
      name: 'viewerId',
      ...
      type: String,
      description:
        'Optional viewer identifier used to customize the returned seeker data.',
      example: '93d5728f-165a-4526-a6d2-00a595dd1e12',
    }),
    ApiResponse({
      status: 201,
...
export function docSeekersPatchById() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        "Updates the seeker's profile with the provided information.",
    }),
    ApiParam({
      name: 'id',
      required: true,
